@echo off
:: ============================================
:: Quake II RTX Head Tracking - Uninstall
:: ============================================
...
:: --- CONFIG BLOCK ---
set "GAME_ID=quake-ii-rtx"
set "MOD_DISPLAY_NAME=Quake II RTX Head Tracking"
set "MOD_DLLS=QuakeIIRTXHeadTracking.asi"
set "MOD_INTERNAL_NAME=QuakeIIRTXHeadTracking"
...
:: DLLs were deployed.
set "MOD_LEFTOVERS=QuakeIIRTXHeadTracking.log QuakeIIRTXHeadTracking.prev.log"
